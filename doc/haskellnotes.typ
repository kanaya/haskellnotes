...
リスト $haskell.list(x)$ が $haskell.list(x)=[x_0,x_1,...,x_n]$ のとき，一般に $union_a^(lozenge.stroked.medium haskell.anonymousoperator lozenge.stroked.medium) haskell.list(x) = a haskell.anonymousoperator x_0 haskell.anonymousoperator x_1 haskell.anonymousoperator ... haskell.anonymousoperator x_n$ が成り立つ．
