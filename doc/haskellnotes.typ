...
型 $haskell.a$ のリストの変数は $x_"s" colon.double [haskell.a]$ という型注釈を持つ．これは $x_"s" colon.double haskell.typeconstructor1([space.thin], haskell.a)$ のシンタックスシュガーである．#footnote[Haskellでは `xs :: [] a` と書く．]
