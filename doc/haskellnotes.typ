...
となるようなMaybeバージョンのマップ演算子 $ast.op.o$ を用いる．ここに $f ast.op.o w_"?"$ の型は，もし $f colon.double haskell.Int -> haskell.Float$ ならば $haskell.MaybeType(haskell.Float)$ である．#footnote[Haskellでは $f ast.op.o w_"?"$ を ```haskell f <$> w``` と書く．]
